...
@RestController
@RequestMapping("/api/eshuttle-kafka")
public class EshuttleKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EshuttleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EshuttleKafkaResource(KafkaProperties kafkaProperties) {
